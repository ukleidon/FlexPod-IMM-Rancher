...
- TENANT - Create the aggregate list variable for tenant SVM
- See the aggregate list
- TENANT - Create SVM with specified protocols enabled
- TENANT - Enable NFS protcol with vstorage
- TENANT - Get the total number of data aggregates created across all nodes in the ONTAP Cluster
- See the aggr count
- TENANT - Create and enable iSCSI service
- TENANT - Create and enable FCP service
- TENANT - Create and enable NVMe service
