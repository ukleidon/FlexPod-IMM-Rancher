...
- TENANT - Create the export policy rules
- TENANT - Create FlexVols for datastores
- TENANT - Disable the volume efficiency on swap volumes
- TENANT - Create a FlexVol for the block storage access
