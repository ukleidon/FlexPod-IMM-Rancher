# Role: `TENANT/ontap_finalize_setup`
...
- TENANT - Configure DNS for tenant SVM
- TENANT - Create and enable auditing configuration for the SVM
- Waiting for configuration to update
- TENANT - Create the HA pairs count variable
- TENANT - Delete the residual default broadcast domains with ifgroups
- TENANT - Send a test to AutoSupport
