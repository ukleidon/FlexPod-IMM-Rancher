...
- TENANT - Create LIF(s) for NFS access
- TENANT - Get the iSCSI LIFs list with their corresponding home nodes
- TENANT - Get the iSCSI storage VLANs list
- TENANT - Create iSCSI LIFs on nodes
- TENANT - Create FCP LIF(s) on Nodes
- TENANT - Create NVMe FC LIF(s) on Nodes
- TENANT - Get the NVMe/TCP LIFs list with their corresponding home nodes
- TENANT - Get the NVMe/TCP storage VLANs list
- TENANT - Create NVMe/TCP LIFs on nodes
- TENANT - Create LIF for SVM Management
- TENANT - Create a default route in infra SVM
