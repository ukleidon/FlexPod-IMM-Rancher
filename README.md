...
| -------------------------------------------------------------- | -------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| [`INFRA.yml`](INFRA.yml)                                       | Build or validate shared FlexPod infrastructure.               | Shared Nexus, ONTAP, Intersight, StorageGRID, mgmt-cluster, and ASA integration objects.                                           |
